...
def generate_model(output_len, chars=None):
    ...
    for layer_number in range(CONFIG.input_layers):
        model.add(
            recurrent.LSTM(CONFIG.hidden_size, input_shape=(None, len(chars)), kernel_initializer=CONFIG.initialization,
...
def read_top_chars():
    ...
    chars = json.loads(open(CHAR_FREQUENCY_FILE_NAME, "r").read())
